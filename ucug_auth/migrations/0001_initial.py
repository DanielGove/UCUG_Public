    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile_picture', models.ImageField(blank=True, default='default.png', upload_to='profile_pics', verbose_name='picture')),
                ('joined', models.DateTimeField(auto_now_add=True, verbose_name='joined')),
                ('last_active', models.DateTimeField(auto_now=True, verbose_name='last_active')),
